...
<p align="center"><img src="https://vignette.wikia.nocookie.net/jjba/images/0/08/Soft%26Wet_ASB.jpg/revision/latest?cb=20151119231639" align="center" height=220/>
</p>
...
Soft & Wet é um projeto de estudo de boas práticas no desenvolvimento de `Shiny Apps` com o pacote `{golem}`.

O pacote `softr` tem como objetivo criar uma plataforma para controle de tickets de lavanderia de prédios residenciais.

## Instalação

A instalação da versão de desenvolvimento do pacote `softr` pode ser realizada via `devtools`.
